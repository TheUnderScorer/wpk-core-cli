 ...
 *
 * */
export function validateForm( $form: JQuery ): boolean
{
...
{
    $( 'input, select, textarea, button', $form ).not( ':disabled' ).attr( 'disabled', true ).addClass( 'was-disabled' );
}

export function enableForm( $form: JQuery ): void
{
    $( '.was-disabled', $form ).attr( 'disabled', false );
}
